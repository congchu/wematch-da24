...
export default function NotFound() {
    ...
    return (
        <>
            <S.Logo><a href={MOVE_URL}><span>위매치</span></a></S.Logo>
            <S.Container>
                <NotFoundIcon className="icon" />
                <S.Title>
                    {
                        isTablet ? '요청하신 페이지를 찾을 수 없습니다' : (
                            <>
                ...
                <S.Button id='dsl_button_empty' onClick={() => window.location.href = `${MOVE_URL}`}>홈으로</S.Button>
            </S.Container>
        </>
    )
}
