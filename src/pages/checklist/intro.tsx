    ...
    <Layout
      ...
      <S.Container>
        ...
        <S.ListContainer>
          <li>
            <span>
              <SvgDotInDot width={17} height={17} />
            </span>
          ...
          <li>
            <span>
              <CheckCircleOff color={colors.pointBlue} />
            </span>
            <strong>이사 1달 전</strong>
            <p>
              이사/청소업체를 알아볼 시기입니다.
              <br />
              업체평가등급을 확인하고 방문견적까지 꼼꼼하게 받아보세요.
            </p>
            <p>견적상담 시 체크리스트를 확인해 보세요.</p>
            <a
              onClick={() => {
                router.history.push("/checklist/moveestimation");
              }}>
              <Download />
              이사 견적 시
            </a>
            <a
              onClick={() => {
                router.history.push("/checklist/cleanestimation");
              }}>
              <Download />
              청소 견적 시
            </a>
          ...
          <li>
            ...
            <a
              onClick={() => {
                router.history.push("/checklist/moveprep");
              }}>
              <Download />
              이사준비 체크리스트
            </a>
          ...
          <li>
            ...
            <a
              onClick={() => {
                router.history.push("/checklist/cleancheck");
              }}>
              <Download />
              점검사항
            </a>
          ...
          <li>
            ...
            <p>
              이사/청소는 잘 하셨나요?
              <br />
              문자로 전송된 평가 링크를 통해 이용한 업체를 솔직하게 평가해주세요.
              <br />
