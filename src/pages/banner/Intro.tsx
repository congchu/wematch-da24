  ...
  function welcome() {
    return isTablet ? (
      <Welcome>
        ...
        <div className="desc">
          <h2 className="bold" style={{ marginBottom: 30 }}>
            잘 찾아오셨어요! 위매치입니다.
          </h2>
          <h3 className="bold" style={{ fontSize: 16, marginBottom: 5 }}>
            1. 500만 명이 선택한 이사업체 평가등급 시스템!
          </h3>
          ...
          <h3 className="bold" style={{ fontSize: 16, marginBottom: 5 }}>
            2. 여러 업체에 무.료.로 방문견적 신청까지 한 번 <br />
            에!
          </h3>
          <p style={{ marginBottom: 40 }}>
            수수료가 있지 않냐고요? NO! <br />
          ...
          <h3 className="bold" style={{ fontSize: 16, marginBottom: 5 }}>
            3. 단 1분만에 나만의 이삿짐센터 후보 확인!
          </h3>
          <p>
            <br />
            클릭 몇 번으로 내 조건에 맞는 맞춤형 이사업체 실 <br />
            시간 매칭! <br />
            <br />
            게다가 실제 이용자들의 솔직하고 가감없는 평가를 <br />
            꼼꼼히 읽어보고 선택할 수 있으니까! <br />
            복잡하고 불안한 이사업체 찾기가 정말 쉬워지고 안 <br />
            심할 수 있습니다.
          </p>
        </div>
      </Welcome>
      ...
      <>
        <img src={require("assets/images/banner/intro_05.png")} alt="위매치,포장이사,이사짐센터,이삿짐센터,포장이사견적비교,이사견적,포장이사비용,보관이사,원룸이사,사다리차,이삿짐보관,가정이사,포장이사업체,이사견적비교사이트,소형이사,S등급" />
        <h2 className="bold" style={{ marginBottom: 20 }}>
          잘 찾아오셨어요! 위매치입니다.
        </h2>
