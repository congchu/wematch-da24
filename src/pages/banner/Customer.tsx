  ...
  const reviews = [
    {
      ...
      data: [
        {
          title: "경기도 김포시 (2020.5.27 이사)",
          review: "커뮤니티를 통해 우연히 추천 받아서 긴가민가 이용해봤는데, 불필요한 연락같은 것도 오지 않아서 좋았구요. 비교업체를 고를 때도 이용자의 후기를 꼼꼼히 볼 수 있어서 도움이 됐습니다. 견적 받은 업체도 다 너무 좋아서 고민될 정도였어요."
        },
    ...
    },
    {
      ...
      data: [
        ...
        {
          title: "서울특별시 강서구 (2020.8.21 이사)",
          review: "평가 댓글을 보면 실제 이용자가 쓴 것 같아 신뢰가 가고, 그런 평가를 의식하여 열심히 하는 업체가 있어서 저도 이번에 선택하는데 도움이 되었습니다. 추천을 안할 이유가 없습니다. <strong>전 2번째 이사인데 모두 이 어플로 했어요.</strong>"
        }
      ]
    },
    {
