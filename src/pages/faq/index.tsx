...
export default function FaqPage() {
    ...
    return(
        <Layout title="자주 묻는 질문">
            {/*이렇게 나중에 나누기*/}
            <S.TopCollapsedWrap>
                <Collapsed category='공통' title='소비자평가등급은 무엇인가요?' defaultExpand={false}>
            ...
            <S.CollapsedWrap>
                <Collapsed category='공통' title='위매치다이사는 이사/청소 업체가 아닌가요?' defaultExpand={false}>
            ...
            <S.CollapsedWrap>
                <Collapsed category='공통' title='평가등급 조작할 수 있지 않나요?' defaultExpand={false}>
                    소비자평가등급은 이사/청소 업체를 실제로 이용한 고객만이 평가에 참여할 수 있는 "직접 피드백 시스템"을 통해 산출되므로 개별 업체가 광고성 후기를 올리거나 자사의 평가 데이터를 조작하는 일은 불가능합니다.
                </Collapsed>
            </S.CollapsedWrap>
            <S.CollapsedWrap>
                <Collapsed category='공통' title='업체 검색 결과에 S 업체가 없습니다.' defaultExpand={false}>
            ...
            <S.CollapsedWrap>
                <Collapsed category='이사' title='마감업체는 무엇인가요?' defaultExpand={false}>
            ...
            <S.CollapsedWrap>
                <Collapsed category='공통' title='상담신청시 개인정보가 공개되나요?' defaultExpand={false}>
                    고객님에 의해 제공된 개인정보는 고객님의 동의 없이 기타목적을 위한 이용이나 제3자에게 제공할 수 없으며, 단지 고객님과 매칭된 업체 상호 간의 상담을 돕기위해 관계법이 허용하는 범위 내에서 제공되어 집니다.
                </Collapsed>
            </S.CollapsedWrap>
            <S.CollapsedWrap>
                <Collapsed category='공통' title='이사/청소 업체에서 현금영수증 또는 세금계산서를 발급해 주나요?' defaultExpand={false}>
                    소비자평가등급은 이사/청소 업체를 실제로 이용한 고객만이 평가에 참여할 수 있는 "직접 피드백 시스템"을 통해 산출되므로 개별 업체가 광고성 후기를 올리거나 자사의 평가 데이터를 조작하는 일은 불가능합니다.
                </Collapsed>
            </S.CollapsedWrap>
            <S.CollapsedWrap>
                <Collapsed category='이사' title='방문견적 부담스러운데, 꼭 받아야 하나요?' defaultExpand={false}>
            ...
            <S.CollapsedWrap>
                <Collapsed category='이사' title='여러 이사업체에서 비교견적 받아봐야 하나요? 몇 개나 받아야 하나요?' defaultExpand={false}>
            ...
            <S.CollapsedWrap>
                <Collapsed category='이사' title='이사견적 시 추가 옵션비용은 어떤 것들이 있나요?' defaultExpand={false}>
            ...
            <S.CollapsedWrap>
                <Collapsed category='공통' title='이사/청소 업체와 계약은 어떻게 하나요?' defaultExpand={false}>
            ...
            <S.CollapsedWrap>
                <Collapsed category='청소' title='여러 청소업체에서 비교견적 받아봐야 하나요?' defaultExpand={false}>
                    각 청소 업체마다 견적과 제공 서비스는 모두 다르기 때문에 합리적인 선택을 위해서는 2개 이상의 업체에 견적을 받아 비교하는 것을 추천드립니다.
                </Collapsed>
            </S.CollapsedWrap>
            <S.CollapsedWrap>
                <Collapsed category='청소' title='이사청소와 입주청소의 차이는 무엇인가요?' defaultExpand={false}>
            ...
            <S.CollapsedWrap>
                <Collapsed category='청소' title='이사 청소는 일반적으로 언제 하나요?' defaultExpand={false}>
