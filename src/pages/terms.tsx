      ...
      <section className="cont_agree">
        ...
        <div id="privacy" className="wrap_agree">
          ...
          <div className="desc_agree">
            ...
            <p>
              2-1. "개인정보"라 함은 생존하는 개인에 관한 정보로서 당해 정보에 포함되어 있는 성명, 주소, 전화번호 등의 사항에 의하여 당해 개인을 식별할 수 있는 정보(당해 정보만으로는 특정 개인을 식별할 수 없더라도 다른 정보와 용이하게 결합하여 식별할 수 있는 것을 포함)를 말합니다. 회사는
              이용자의 사전 동의 없이는 이용자의 개인 정보를 함부로 공개하지 않으며, 수집된 정보는 아래와 같이 이용하고 있습니다.
            </p>
            <ul>
              <ul>
                <li>
                ...
                <li>
                  ...
                  신규서비스 개발 및 고객맞춤서비스 제공, 통계학적 특성에 따른 서비스 제공, 서비스의 유효성 확인, 이벤트 정보 및 참여기회 제공, 광고성 정보 제공, 접속빈도 파악, 이용자의 서비스이용에 대한 통계 등의 용도로 활용됩니다. 또한 회사의 서비스와 관련된 뉴스, 이벤트, 업데이트 정보
                  등의 소식을 받아보실 수 있도록 이용자의 동의를 구하고 발송하는 회사의 이메일링, SMS수신서비스를 보다 원활하게 제공하기 위한 목적으로 사용됩니다. 회사는 이용자가 서비스 이용 시 마케팅 활용 동의 절차에서 「동의」를 선택함으로써 상기 이벤트 정보 및 광고성 정보 제공 등의
          ...
          <div className="desc_agree">
            ...
            <p>
              3-1. 회사가 제공하는 서비스를 이용하기 위해서는 각 서비스의 종류에 따라 회원가입이나 실명인증이 필요할 수 있으며 본 약관에서는 회원용 서비스를 위한 공통 수집항목을 고지하고 있습니다. 수집항목은 각 서비스에 따라 달라질 수 있으며 해당 서비스의 별도 약관 및 서비스 신청 과정에서
              확인할 수 있습니다.
            </p>
            <p>3-1-1. 개인정보 수집항목</p>
            <ul>
            ...
            <p>
              3-4. 회사는 온라인 상의 회원가입, 회원정보수정 및 서비스 화면, 회사가 제공하는 서면양식, 전화 또는 팩스, 이메일, 회원사를 통해 개인정보를 수집할 수 있습니다. 이용자는 이상의 개인정보 수집 과정에서 「동의」를 선택할 수 있으며 이 경우 개인정보 수집에 동의한 것으로 간주됩니다.
            </p>
          </div>
          <div className="desc_agree">
            ...
            <br />
            <p>이용자는 언제든지 아래의 "7. 개인정보 수집, 이용, 제공에 대한 동의철회"에서 설명한 절차와 방법에 따라 본인이 직접 개인정보 삭제를 요청할 수 있으며, 이 경우 개인정보는 재생할 수 없는 방법에 의하여 디스크에서 완전히 삭제되어 추후 열람이나 이용이 불가능한 상태로 처리됩니다.</p>
            <br />
            <p>
          ...
          <div className="desc_agree">
            ...
            <p>
              ...
              회사는 서비스 제공 계약 이행과 이용자 편의 증진을 위해 아래와 같은 업무를 외부 업체에 위탁해 처리하고 있습니다. 회사에서 이용자의 개인정보를 위탁하는 현황은 하단과 같으며, 위탁받은 업체가 개인정보를 안전하게 처리하도록 필요한 사항을 규정하고 관리/감독을 하고 있고, 수탁사 및
              위탁업무의 내용이 변경될 경우, 회사는 본 개인정보처리방침을 통해 제공받는 자, 제공목적, 제공정보 항목, 제공기간을 회원에게 고지하여 동의를 구합니다
            </p>
            <ul>
              <ul>
                <br />
            ...
            <br />
            <p>
              회사는 서비스 제공의 안정성과 최신 기술을 이용자에게 제공하기 위해 상기 업체에게 개인정보를 위탁하여 이용자로부터 취득 또는 생성한 개인정보를 AWS (Amazon Web Services Inc.)가 보유하고 있는 데이터베이스(물리적 저장 장소: 서울)에 저장합니다. AWS는 해당 서버의 물리적인 관리만을
              행하고, 이용자의 개인정보에 접근할 수 없습니다.
            </p>
            <br />
            <p>
          ...
          <div className="desc_agree">
            ...
            <p>
              9-1. 이용자의 개인정보를 처리함에 있어 개인정보가 분실, 도난, 누출, 변조 또는 훼손되지 않도록 안전성 확보를 위하여 다음과 같은 기술적-관리적 대책을 강구하고 있습니다. 그러나 이용자의 주민등록번호는 공공장소에서의 인터넷사용 등 여러 방법으로 타인에게 알려질 가능성이 높으므로
              이의 보호를 철저히 하는 것이 무엇보다 중요합니다. 그러므로 이용자도 개인의 정보를 타인에게 유출시키거나 제공하여서는 아니 되며, 자신의 개인정보를 책임 있게 관리할 의무가 있습니다. 개인의 관리소홀로 인한 개인정보 유출에 대해 당사는 어떠한 책임도 지지 않습니다.
            </p>
