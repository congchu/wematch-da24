  ...
  return (
    <Container>
      ...
      <Section>
        ...
        <Input theme={'default'} placeholder={'평형 입력 ex)24'} border style={{ backgroundColor: 'transparent', fontSize: 16 }} onChange={(e) => setHouseSpace(e.target.value)} value={houseSpace} />
      </Section>
      <Section>
        <Title>옵션 선택</Title>
        <OptionGroups>
