...
function Review() {
  ...
  const reviews = [
    {
      ...
      customer: 591423,
      created_at: "1달 내 이사",
      partnerArea: "서울시 강서구 A등급 업체"
    },
    {
      partnerName: "아프리카익스프레스",
      grade: "최고",
      price: "최고에요",
      kind: "좋아요",
      professional: "최고에요",
  ...
  return (
    <S.Container id="dsl_move_review_more_1">
      ...
      <CustomSwiper centeredSlides={true} centeredSlidesBounds={true} pagination={{ clickable: true }} width={330} loop={true} autoplay={autoPlayOptions} loopAdditionalSlides={1} breakpoints={{ 768: { slidesPerView: 3, centeredSlides: false, centeredSlidesBounds: false, width: 990 } }}>
