...
function Review() {
    ...
    const reviews = [
        ...
        {
            partnerName: '인천광역시 남동구 S등급 업체', grade: '최고', price: 5, kind: 5, professional: 5,
            content: '이분들께는 안되는건 없으신거같아요!!\n' + '정말 최고의 이사였습니다. 무조건 이 업체 추천입니다믿고 진행하셔도 됩니다!!!',
            customer: 591332, created_at: '2020.09.30'
        },
        {
            partnerName: '수원시 영통구 S등급 업체', grade: '최고', price: 3, kind: 5, professional: 5,
            content: '전반적으로 만족스러웠습니다. 버릴 물건이 많았는데 잘 보내 주셨어요! 다 열심히 해 주셨고 특히 부엌 담당해 주신 분 감사합니다.',
            customer: 591206, created_at: '2020.09.30'
        },
        {
            partnerName: '의정부시 A등급 업체', grade: '최고', price: 5, kind: 5, professional: 4,
            content: '엄청 꼼꼼하고 친절하게 잘 해주셨습니다. 저는 보관이사라서 11월에 한번 더 이용예정인데 믿고 이용할수 있을것 같습니다 ^^',
            customer: 590849, created_at: '2020.09.29'
        },
        {
            partnerName: '서울시 성동구 S등급 업체', grade: '매우 만족', price: 4, kind: 4, professional: 5,
            content: '짐이 예상보다 오버하여 용달을 불렀는데, 계약대로 추가 비용없이 되는거라고 먼저 설명해주시고, 새집에 고장난것도 손바주셨어요!',
            customer: 590625, created_at: '2020.09.29'
        },
