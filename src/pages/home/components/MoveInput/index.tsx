...
const MoveInput: React.FC<Props> = (props) => {
  ...
  return (
    <S.Container id="dsl_move_input_terms_1" {...restProps} type={type}>
      ...
      <CalendarModal visible={visibleCalendarModal} title="이사 예정일이 언제세요?" onClose={toggleCalendarCancel} onSelect={onSelectDate} selected={getMoveDate} serviceType={'move'}/>
