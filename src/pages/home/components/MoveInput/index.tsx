    ...
    <S.Container id="dsl_move_input_terms_1" {...restProps} type={type}>
      <S.Form>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', marginTop: '24px' }}>
          ...
          <Input theme="default" border readOnly icon="down" placeholder="층수" rootStyle={{ width: '100%' }} onClick={toggleStartFloor} value={getMoveFloor.start ? getMoveFloor.start + '층' : getMoveFloor.start} style={{ backgroundColor: 'transparent' }} />
        </div>
