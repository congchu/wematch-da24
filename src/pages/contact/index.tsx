  ...
  return (
    <Layout title="문의하기">
      <S.Form>
        ...
        />
        <Input theme="default" border readOnly icon="down" placeholder="서비스 종류" rootStyle={{}} style={{ fontSize: "16px", color: colors.black }} onClick={toggleCategory} value={serviceType} />
        <Input theme="default" border readOnly icon="down" placeholder="문의 종류" rootStyle={{}} style={{ fontSize: "16px", color: colors.black }} onClick={toggleType} value={contactType} />
        <S.TextContainer>
          <S.Textarea
            style={{ fontSize: "16px" }}
            value={contents}
