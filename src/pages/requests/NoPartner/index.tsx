  ...
  return (
    <S.Container>
      ...
      <S.ChangeDate>
        ...
        <CalendarModal visible={visibleCalendarModal} title="이사 예정일이 언제세요?" serviceType={'moving'} onClose={toggleCalendarCancel} onConfirm={toggleCalendarConfirm} onSelect={onSelectDate} selected={serviceType === 'move' ? getMoveDate : cleanDate} />
