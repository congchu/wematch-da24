...
export const submitFormAsync = createAsyncAction('FETCH_SUBMIT_FORM_REQUEST', 'FETCH_SUBMIT_FORM_SUCCESS', 'FETCH_SUBMIT_FORM_FAILURE')<{ formData: types.RequestUserInfoInsert }, SubmittedForm, undefined>()
