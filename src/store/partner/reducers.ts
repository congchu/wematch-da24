...
export default createReducer<PartnerState, Actions>(initialState)
    ...
    .handleAction(actions.fetchReviewListAsync.success, (state, action) => ({ ...state, review: { data: [...state.review.data, ...action.payload.data], loading: false, hasMore: action.payload.has_more }}))
