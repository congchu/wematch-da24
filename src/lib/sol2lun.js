 ...
 * https://article.itxueyuan.com/y2On9
 */
...
const calendar = {
     ...
     * @return Cn string
     */
    Gan: ["u7532", "u4e59", "u4e19", "u4e01", "u620a", "u5df1", "u5e9a", "u8f9b", "u58ec", "u7678"],
     ...
     * @return Cn string
     */
    Zhi: ["u5b50", "u4e11", "u5bc5", "u536f", "u8fb0", "u5df3", "u5348", "u672a", "u7533", "u9149", "u620c", "u4ea5"],
     ...
     * @return Cn string
     */
    Animals: ["u9f20", "u725b", "u864e", "u5154", "u9f99", "u86c7", "u9a6c", "u7f8a", "u7334", "u9e21", "u72d7", "u732a"],
     ...
     * @return Cn string
     */
    solarTerm: ["u5c0fu5bd2", "u5927u5bd2", "u7acbu6625", "u96e8u6c34", "u60cau86f0", "u6625u5206", "u6e05u660e", "u8c37u96e8", "u7acbu590f", "u5c0fu6ee1", "u8292u79cd", "u590fu81f3", "u5c0fu6691", "u5927u6691", "u7acbu79cb", "u5904u6691", "u767du9732", "u79cbu5206", "u5bd2u9732", "u971cu964d", "u7acbu51ac", "u5c0fu96ea", "u5927u96ea", "u51acu81f3"],
     ...
     * @return Cn string
     */
    nStr1: ["u65e5", "u4e00", "u4e8c", "u4e09", "u56db", "u4e94", "u516d", "u4e03", "u516b", "u4e5d", "u5341"],
     ...
     * @return Cn string
     */
    nStr3: ["u6b63", "u4e8c", "u4e09", "u56db", "u4e94", "u516d", "u4e03", "u516b", "u4e5d", "u5341", "u51ac", "u814a"],
     ...
     */
    nStr4: {
        "0101": "u5143u65e6u8282", // 公历1月1日
        "0501": "u52b3u52a8u8282", // 公历5月1日
        "1001": "u56fdu5e86u8282", // 公历10月1日
        "0308": "u5987u5973u8282", // 公历3月8日
        "0504": "u9752u5e74u8282", // 公历5月4日
        "0601": "u513fu7ae5u8282", // 公历6月1日
        "0801": "u5efau519bu8282" // 公历8月1日
    },
     ...
     */
    nStr5: {
        "0101": "u6625u8282", // 农历正月初一
        "0505": "u7aefu5348u8282", // 农历五月初五
        "0815": "u4e2du79cbu8282" // 农历八月十五
    },
     ...
     */
    leapMonth: function (y) { //闰字编码 u95f0
    ...
    toAstro: function (m, d) {
        ...
        return s.substr(m * 2 - (d < arr[m - 1] ? 2 : 0), 2) + "u5ea7";//座
    },
     ...
     */
    toChinaMonth: function (m) { // 月 => u6708
        if (m > 12 || m < 1) {
            return -1
        } //若参数错误 返回-1
    ...
    isLuckyDay: function(d) {
        const data = [9, 10, 19, 20, 29, 30];
    ...
    solar2lunar: function (y, m, d) { //参数区间公历1900.1.31~2100.12.31
        ...
        return {
            ...
            'IMonthCn': (isLeap ? "u95f0" : '') + calendar.toChinaMonth(month),
            ...
            'isLeap': isLeap,
            'nWeek': nWeek,
            'ncWeek': "u661fu671f" + cWeek,
            'weekOfYear': "u7b2c" + calendar.getWeekOfYear(y, m, d) + "u5468",
    ...
    lunar2solar: function (y, m, d, isLeapMonth) { //参数区间农历1900.1.1~2100.12.1
        ...
        if (isLeapMonth && (leapMonth != m)) { // 计算得出的闰月与传参的月份不同
            return -1;
        }
