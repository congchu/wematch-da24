...
const PopupTemplate: React.FC<Props> = (props) => {
  const { visible, border = false, onOverlayClose, footerButton, onCancelButtonText, onCancelClick, onConfirmButtonText, onConfirmClick, children, leftCustomButtonStyle, rightCustomButtonStyle } = props;
