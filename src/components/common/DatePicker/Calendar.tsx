...
function Day(props: DayProps) {
  const { type, isSelected, disabled, children, onClick, isLuckyDay, ...restProps } = props;
...
export default function Calendar(props: Props) {
  const { serviceType, maxDate, currentDate, selected, onSelect, disabledDate, ...restProps } = props;
