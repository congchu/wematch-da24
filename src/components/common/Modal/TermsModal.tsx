            ...
            <S.Container>
                <S.TermsWrap>
                    ...
                    <S.Agree>
                        ...
                        <ul>
                            <li>(1) 이용자의 이사/청소조건에 맞는 추천 서비스 제공<br/>
                                이사/청소전문대행사(회원사)의 이사견적 비교제공 및 이사진행을 위한 사전연락, 전화견적 · 방문견적 및 방문이사진행</li>
                            <li>(2) 이용자 사후관리<br/>
                                계약 이행 후, 회사 및 이사/청소전문대행사(회원사)에 대한 피드백 반영을 위한 해피콜, AS, 이사 후평가를 위한 이용자 확인</li>
                            <li>(3) 신규서비스 개발 및 마케팅, 광고에의 활용<br/>
                                <ul>
                                    <li>• 신규서비스 개발 및 고객맞춤/통계학적 특성에 따른 서비스 제공, 서비스 유효성 확인, 이벤트 정보 및 참여기회 제공, 광고성 정보 제공,
                                        접속빈도 파악, 서비스이용 통계
                                    </li>
                    ...
                    <S.Agree>
                        <h4>3. 개인정보 제3자 제공 </h4>
                        <p>회사는 서비스의 원활한 제공을 위해 최소한의 범위 내에서 아래와 같이 제3자에게 정보를 제공합니다. 정보주체인 이용자는 본 개인정보의 수집 및 이용에 관한 동의를
                            거부하실 권리가 있으나, 해당 정보는 서비스 제공에 필요한 최소한의 개인정보이므로 동의를 해주셔야 서비스를 이용하실 수 있습니다. </p>
                        <br />
                            <ul>
                                <li>제공 업체 : (주)다이사 회원사 <br />
                                    제공 목적 : 이사/청소 중개 <br />
                                    제공 항목 : 항목2의 필수 항목 <br />
                                    제공받는 자의 개인정보 보유/이용기간 : 이용목적 달성 시 혹은 회원계약 종료 시 <br /><br />
                                </li>
                                <li>
                                    제공 업체 : (주)엠디서비스 <br />
                                    제공 목적 : (주)다이사 회원사의 영업/상담대행 (이사/청소견적서비스 및 고객주문정보, 이사, 청소, 기타 부가서비스 등 고객상담 서비스 및 민원처리 업무,
                                    주문 또는 취소처리 관리) <br />
                                    제공 항목 : 항목2의 필수 항목 <br />
                                    제공받는 자의 개인정보 보유/이용기간 : 이용목적 달성 시 혹은 회원계약 종료 시 <br /><br />
                                </li>
                                <li>
                                    제공 업체 : ㈜마켓디자이너스 <br />
                                    제공 목적 : 이사/청소 신청내역 조회, 위매치 통합 부가서비스 제공, 신규서비스 추천<br />
                                    제공 항목 : 항목2의 필수 항목 <br />
