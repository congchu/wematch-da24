  ...
  public render() {
    return(
        <svg width={this.props.width} height={this.props.height} style={this.props.style} className={this.props.className}  viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M4 7L8 10L12 7" stroke={this.props.color} strokeLinecap="round"/>
          <path d="M2 9V14H14V9" stroke={this.props.color} strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M8 10V2" stroke={this.props.color} strokeLinecap="round"/>
        </svg>
        )
