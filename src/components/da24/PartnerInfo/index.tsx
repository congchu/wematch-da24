      ...
      <S.Wrap>
        ...
        <S.Info>
          ...
          <S.Card>
            <span>고객선택</span>
            <em>
              {pick_cnt ? commaInNumbers(pick_cnt) : 0}
              <p> 회</p>
            </em>
          </S.Card>
          <S.Card>
        ...
        {level === "NEW" && (
          <S.Box>
            ...
            <p>
              최근에 파트너가 된 업체로 의욕적인 서비스를 기대할 수 있습니다.
              <br className="hide" /> 통계적으로 신규 파트너 업체의 이사 만족도 평가는 우수 등급과 같거나 보다 높습니다.
            </p>
          </S.Box>
        )}
        <S.Description>
          ...
          {!isEmpty(keywords) && keywords[0].length > 0 && (
            <S.Option>
