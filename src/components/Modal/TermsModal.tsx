          ...
          <S.ContentWrapper>
            ...
            <div className="wrap_agree">
              ...
              <div className="desc_agree fst">
                ...
                <p>
                  이 약관은 (주)다이사(이하 `회사`)가 운영하는 위매치다이사 사이트(http://da2④wematch.com, 이하 `위매치다이사`)를 통해서 제공하는 서비스(이하 `서비스`)를 이용함에 있어 사업자와 이용자간의 이사 · 청소 종합서비스에 대한 계약사항 및 회사와 이용자간의 권리 및 의무 및 책임사항을
              ...
              <div className="desc_agree">
                ...
                <ul>
                  <li>
                    ① 회사는 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호, 모사전송번호, 전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자 등을 이용자가 쉽게 알 수 있도록 사이트의 초기
                  ...
                  <li>
                    ④ 회사가 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 사이트의 초기화면에 그 적용일자 7일이전부터 적용일자 전일까지 공지합니다. 다만, 이용자에게 불리하게 약관내용을 변경하는 경우에는 최소한 30일 이상의 사전 유예기간을 두고 공지합니다. 이 경우
                    회사는 개정전 내용과 개정후 내용을 명확하게 비교하여 이용자가 알기 쉽도록 표시합니다.
                  </li>
                  <li>
            ...
            <div className="wrap_agree">
              ...
              <div className="desc_agree">
                ...
                <ul>
                  ...
                  <li>
                    3. “회사”의 공식 사이트 이외의 링크된 사이트에서는 “회사”의 개인정보취급방침이 적용되지 않습니다. 서비스를 제공하는 제3자의 개인정보 취급과 관련하여는 해당사이트 및 해당 제3자의 개인정보취급방침을 확인할 책임이 이용자에게 있으며, “회사”는 이에 대하여 책임을 부담하지
                    않습니다.
                  </li>
                  <li>
            ...
            <div id="privacy" className="wrap_agree">
              <h3 className="title_agree">개인정보처리방침</h3>
              <p>
                (주)다이사(이하 “회사”)는 위매치 서비스(이하 “서비스”)를 제공함에 있어 귀하의 개인정보보호를 매우 중요시하며, 『개인정보보호법』,『정보통신망 이용촉진 및 정보보호에 관한 법률』상의 개인정보보호규정 및 정보통신부가 제정한 『개인정보보호지침』을 준수하고 있습니다. 회사는
                개인정보처리방침을 통하여 이용자가 제공하는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.
              </p>
              <div className="desc_agree">
              ...
              <div className="desc_agree">
                ...
                <p>
                  2-1. "개인정보"라 함은 생존하는 개인에 관한 정보로서 당해 정보에 포함되어 있는 성명, 주소, 전화번호 등의 사항에 의하여 당해 개인을 식별할 수 있는 정보(당해 정보만으로는 특정 개인을 식별할 수 없더라도 다른 정보와 용이하게 결합하여 식별할 수 있는 것을 포함)를 말합니다.
                ...
                <ul>
                  <ul>
                    ...
                    <li>
                      ...
                      신규서비스 개발 및 고객맞춤서비스 제공, 통계학적 특성에 따른 서비스 제공, 서비스의 유효성 확인, 이벤트 정보 및 참여기회 제공, 광고성 정보 제공, 접속빈도 파악, 이용자의 서비스이용에 대한 통계 등의 용도로 활용됩니다. 또한 회사의 서비스와 관련된 뉴스, 이벤트, 업데이트
                      정보 등의 소식을 받아보실 수 있도록 이용자의 동의를 구하고 발송하는 회사의 이메일링, SMS수신서비스를 보다 원활하게 제공하기 위한 목적으로 사용됩니다. 회사는 이용자가 서비스 이용 시 마케팅 활용 동의 절차에서 「동의」를 선택함으로써 상기 이벤트 정보 및 광고성 정보 제공
                      등의 목적으로 활용함에 동의한 것으로 봅니다.
                    </li>
                  </ul>
                </ul>
              </div>
              <div className="desc_agree">
                ...
                <p>
                  3-1. 회사가 제공하는 서비스를 이용하기 위해서는 각 서비스의 종류에 따라 회원가입이나 실명인증이 필요할 수 있으며 본 약관에서는 회원용 서비스를 위한 공통 수집항목을 고지하고 있습니다. 수집항목은 각 서비스에 따라 달라질 수 있으며 해당 서비스의 별도 약관 및 서비스 신청
                  과정에서 확인할 수 있습니다.
                </p>
                <p>3-1-1. 개인정보 수집항목</p>
                <ul>
                ...
                <p>
                  3-2. 회사는 이용자의 기본적 인권 침해의 우려가 있는 민감한 개인정보(인종 및 민족, 사상 및 신조, 출신지 및 본적지, 정치적 성향 및 범죄기록, 건강상태 및 성생활 등)는 가급적 수집하지 않으며 부득이하게 수집해야 할 경우 이용자의 사전동의를 반드시 구할 것입니다. 그리고, 어떤
                  경우에라도 입력하신 정보를 이용자에게 사전에 밝힌 목적 이외에 다른 목적으로는 사용하지 않으며 외부로 유출하지 않습니다.
                </p>
                <p>3-3. 회사는 개인정보의 수집 및 이용 목적에 따라 고객과 상담원 간의 통화내용을 녹취할 수 있습니다.</p>
                <p>
                  3-4. 회사는 온라인 상의 회원가입, 회원정보수정 및 서비스 화면, 회사가 제공하는 서면양식, 전화 또는 팩스, 이메일, 회원사를 통해 개인정보를 수집할 수 있습니다. 이용자는 이상의 개인정보 수집 과정에서 「동의」를 선택할 수 있으며 이 경우 개인정보 수집에 동의한 것으로
                  간주됩니다.
                </p>
              </div>
              <div className="desc_agree">
                ...
                <p>
                  4-3. 파기방법 <br />
                  회사는 이용자의 개인정보를 안전하게 처리하며, 이용자의 개인정보는 수집 및 이용목적이 달성된 후에는 지체없이 파기합니다. 종이에 출력된 개인정보는 분쇄하거나 소각 등을 통하여 파기하고, 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여
                  파기합니다.
                </p>
              </div>
              <div className="desc_agree">
                ...
                <p>
                  ...
                  회사는 서비스 제공 계약 이행과 이용자 편의 증진을 위해 아래와 같은 업무를 외부 업체에 위탁해 처리하고 있습니다. 회사에서 이용자의 개인정보를 위탁하는 현황은 하단과 같으며, 위탁받은 업체가 개인정보를 안전하게 처리하도록 필요한 사항을 규정하고 관리/감독을 하고 있고, 수탁사
                  및 위탁업무의 내용이 변경될 경우, 회사는 본 개인정보처리방침을 통해 제공받는 자, 제공목적, 제공정보 항목, 제공기간을 회원에게 고지하여 동의를 구합니다
                </p>
                <ul>
                  <ul>
                    <br />
                ...
                <br />
                <p>
                  회사는 서비스 제공의 안정성과 최신 기술을 이용자에게 제공하기 위해 상기 업체에게 개인정보를 위탁하여 이용자로부터 취득 또는 생성한 개인정보를 AWS (Amazon Web Services Inc.)가 보유하고 있는 데이터베이스(물리적 저장 장소: 서울)에 저장합니다. AWS는 해당 서버의 물리적인
                  관리만을 행하고, 이용자의 개인정보에 접근할 수 없습니다.
                </p>
                <br />
                <p>
                  5-3. 목적 외 이용 및 제3자 제공 <br />
                  회사는 이용자 개인정보를 「개인정보의 수집목적 및 이용목적」에서 고지한 범위 내에서 사용하며, 동 범위를 초과하여 이용하거나 타인 또는 타기업, 기관에 제공하지 않습니다. 단, 양질의 서비스 제공을 위해 이용자의 개인정보를 협력업체와 공유할 필요가 있는 경우에는 제공받는 자,
                  제공목적, 제공정보 항목, 제공기간을 회원에게 고지하여 동의를 구합니다.
                </p>
              </div>
              <div className="desc_agree">
              ...
              <div className="desc_agree">
                ...
                <p>
                  회사는 이용자에게 다양하고 차별화된 서비스를 제공하기 위하여 이용자에 대한 정보를 저장하고 수시로 찾아내는 쿠키(cookie)를 사용합니다. 쿠키란 웹사이트서버가 사용자의 컴퓨터 브라우저에게 전송하는 소량의 정보입니다. 이용자가 당사 인터넷사이트에 접속을 하면 이용자의 컴퓨터는
                  브라우저에 저장되어 있는 쿠키의 내용을 읽고, 이용자의 추가정보를 컴퓨터에서 찾아 접속에 따른 성명 등의 추가 입력 없이 서비스를 제공할 수 있습니다. 쿠키는 이용자의 컴퓨터는 식별하지만 이용자를 개인적으로 식별하지는 않습니다.
                </p>
                <ul>
                  <ul>
                    <li>
              ...
              <div className="desc_agree">
                ...
                <p>
                  9-1. 이용자의 개인정보를 처리함에 있어 개인정보가 분실, 도난, 누출, 변조 또는 훼손되지 않도록 안전성 확보를 위하여 다음과 같은 기술적-관리적 대책을 강구하고 있습니다. 그러나 이용자의 주민등록번호는 공공장소에서의 인터넷사용 등 여러 방법으로 타인에게 알려질 가능성이
                  높으므로 이의 보호를 철저히 하는 것이 무엇보다 중요합니다. 그러므로 이용자도 개인의 정보를 타인에게 유출시키거나 제공하여서는 아니 되며, 자신의 개인정보를 책임 있게 관리할 의무가 있습니다. 개인의 관리소홀로 인한 개인정보 유출에 대해 당사는 어떠한 책임도 지지 않습니다.
                </p>
                ...
                <p>
                  9-1-3. 회사는 이용자의 개인정보보호의 중요성을 인식하고 있으며 이를 위해 개인정보처리자를 최소한으로 제한하고 있으며 개인정보관리책임자가 처리자를 대상으로 주기적인 교육을 실시하여 개인정보보호를 위해 최선을 다하고 있습니다. 또한 본 정책에 명시된 이행사항 및 관련 직원의
              ...
              <div className="desc_agree">
                ...
                <ul>
                  <ul>
                    ...
                    <li>(4) 정확한 개인정보의 이용 및 제공을 위해 수정이 완료될 때까지 이용자의 개인정보는 이용되거나 제공되지 않습니다. 또한, 이미 제3자에게 제공된 경우에는 지체 없이 제공받은 자에게 사실을 알려 수정이 이루어질 수 있도록 하겠습니다.</li>
                  </ul>
                </ul>
              </div>
              <div className="desc_agree">
              ...
              <div className="desc_agree">
                ...
                <p>
                  이용자의 개인정보에 대한 보안유지책임은 해당 이용자 자신에게 있습니다. 회사에서는 성명. 주민등록번호에 대해 어떠한 방법으로도 이용자에게 직접적으로 질문하는 경우는 없으므로 타인에게 비밀번호가 유출되지 않도록 각별히 주의하시기 바랍니다. 특히 “9. 개인정보관련
                  기술적-관리적대책”항에서 명시한 것과 같이 공공장소에서 온라인상에서 접속해 있을 경우에는 더욱 유의하셔야 합니다. 회사는 고객의 개인정보를 보호하고 개인정보와 관련한 고객의 불만사항을 처리하기 위하여 개인정보 보호책임자를 두고 있습니다.
                  <br />
                </p>
                <ul>
                  <ul>
                ...
                <p>본 개인정보처리방침은 2020년 7월 20일에 작성되었습니다.</p>
                <br />
              </div>
            </div>
          </S.ContentWrapper>
