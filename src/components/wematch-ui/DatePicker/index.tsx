  ...
  return (
    <S.Container>
      <header>
        ...
        <S.CurrentMonth>{currentDateValue.year()}년 {currentDateValue.month() + 1}월</S.CurrentMonth>
        {
      ...
      <S.CalendarContainer>
        <Calendar currentDate={currentDateValue} onSelect={onSelect} disabledDate={disabledDateWithRange}
          selected={selected} />
      </S.CalendarContainer>
    </S.Container>
